...
export const ConfirmationPage: React.FC = () => {
  ...
  const handleDownloadInvoice = () => {
    ...
    doc.text(`Payment: Successfully Submitted`, rightX + 4, y + 31);
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-swiggy border border-slate-100 space-y-6">
        ...
        <div className="bg-emerald-50 p-4 rounded-2xl border border-emerald-200 flex items-center justify-between gap-4 text-xs">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-extrabold text-emerald-950 block">Payment Submitted Successfully ✅</span>
              <span className="text-emerald-800 text-[11px]">Receipt sent to owner on WhatsApp</span>
            </div>
          </div>
