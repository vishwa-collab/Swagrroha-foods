...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'yellow-sakinalu',
    name: 'Special Yellow Sakinalu',
    teluguName: 'పసుపు సకినాలు',
    category: 'Snacks',
    basePrice: 350,
    priceUnitText: '₹350 / kg',
    description: 'Authentic festival sakinalu prepared with freshly ground rice flour, sesame seeds, and turmeric.',
