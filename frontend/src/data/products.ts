...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'gujiya',
    name: 'Sweet Gujiya (Kajjikayalu / Garijalu)',
    teluguName: 'గరిజెలు / కజ్జికాయలు',
    category: 'Sweets',
    basePrice: 480,
    priceUnitText: '₹480 / kg',
